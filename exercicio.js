...
const numeros = "5555666677778887".split('')
const ultimoNumero = Number(numeros.pop())
const somaEMultiplicacao = numeros
  .reverse()
  .map((numero, i) => {
    if (i % 2 === 0) {
      if (numero >= 5) {
...
const resultado = somaEMultiplicacao
  .reduce((atual, acumulador) => atual + acumulador, ultimoNumero)
const numeroValido = resultado % 10 === 0 ? true : false
